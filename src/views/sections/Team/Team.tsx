        ...
        <section className="team" id="team">
            ...
            <div className="team__box">
                <article className="team__box-people">
                    ...
                    <p className="team__box-people-description">Patron d'une entreprise du BTP, il connait les problématiques terrain par cœur. Il pilote le projet avec une vision claire : Construire un outil utile, concret et au centre du métier.</p>
                </article>
                <article className="team__box-people">
                    <img src={Team_member} alt="" aria-hidden="true" className='team__box-people-image'/>
                    <h5 className="team__box-people-name">Romain Biteau</h5>
                    <h6 className="team__box-people-role">cto & lead dev</h6>
                    <p className="team__box-people-description">Entrepreneur et développeur, il supervise la partie technique du projet. Son rôle, transformer une vision en une solution pratique et bien pensée.</p>
                </article>
            </div>
